...
class Agent():
    ...
    def choose_action(self, obs):
        ...
        probs, _ = self.actor_critic.forward(state) #not probs yet
    ...
    def learn(self, state, reward, state_, done):
        ...
        _, vs = self.actor_critic.forward(state)
        _, vs_ = self.actor_critic.forward(state_)
    ...
    def save_model(self, fname='model'):
        T.save(self.actor_critic, fname)

    def load_model(self, fname):
        self.actor_critic = T.load(fname)
