...
# Contnuous states. n Discrete Actions
class ContGridWorld_v3(gym.Env):
    
    def __init__(self, state_dim=2, action_dim=1, n_actions=8, grid_dim=[10.,10.],start_pos=[5.0,2.0], target_pos=[8.0,8.0], target_rad=1, F=1):
        super(ContGridWorld_v3, self).__init__()
        return 
